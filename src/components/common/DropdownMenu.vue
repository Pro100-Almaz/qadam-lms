...
const props = defineProps({
  ...
  menuClass: {
    type: String,
    default:
      'absolute right-0 top-full z-40 mt-1 w-40 max-w-[calc(100vw-2rem)] space-y-1 rounded-2xl border border-gray-200 bg-white p-2 shadow-lg dark:border-gray-800 dark:bg-gray-dark',
  },
  itemClass: {
    type: String,
    default:
